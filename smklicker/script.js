...
let upgrades = [
    // Upgrades Globais
    { id: 'cafe_expresso', icone: '🌎', nome: 'Garrafa de Café Expresso', desc: 'Duplica TODAS as estruturas (SPS x2). O streamer não dorme, a live não para.', custo: 100000, comprado: false, tipo: 'global', visivel: false },
    { id: 'cadeira_ergonomica', icone: '🌎', nome: 'Cadeira Gamer Ergonômica', desc: 'Duplica TODAS as estruturas (SPS x2). Fim das dores nas costas, lives de 12 horas desbloqueadas.', custo: 5000000, comprado: false, tipo: 'global', visivel: false }, // 5 Milhões
    { id: 'fibra_optica', icone: '🌎', nome: 'Internet Fibra Óptica 1 Giga', desc: 'Duplica TODAS as estruturas (SPS x2). Zero lag de upload, a transmissão flui na velocidade da luz.', custo: 250000000, comprado: false, tipo: 'global', visivel: false }, // 250 Milhões
    { id: 'iluminacao_pro', icone: '🌎', nome: 'Kit de Softbox e LEDs', desc: 'Duplica TODAS as estruturas (SPS x2). A iluminação profissional deixa a webcam com cara de cinema.', custo: 15000000000, comprado: false, tipo: 'global', visivel: false }, // 15 Bilhões
    { id: 'mic_estudio', icone: '🌎', nome: 'Microfone Condensador de Estúdio', desc: 'Duplica TODAS as estruturas (SPS x2). Voz de locutor de rádio, retenção máxima de público no Just Chatting.', custo: 1000000000000, comprado: false, tipo: 'global', visivel: false }, // 1 Trilhão
    { id: 'camera_4k', icone: '🌎', nome: 'Câmera Mirrorless 4K', desc: 'Duplica TODAS as estruturas (SPS x2). Cada poro do seu rosto é renderizado em altíssima definição.', custo: 75000000000000, comprado: false, tipo: 'global', visivel: false }, // 75 Trilhões
    { id: 'dual_pc', icone: '🌎', nome: 'Setup Dual PC da NASA', desc: 'Duplica TODAS as estruturas (SPS x2). Jogar EA FC, Cyberpunk e streamar ao mesmo tempo sem perder 1 frame.', custo: 5e15, comprado: false, tipo: 'global', visivel: false }, // 5 Quadrilhões
    { id: 'selo_parceiro', icone: '🌎', nome: 'Parceria Oficial (Verificado)', desc: 'Duplica TODAS as estruturas (SPS x2). O algoritmo da Twitch finalmente te nota e recomenda pra todo mundo.', custo: 500e15, comprado: false, tipo: 'global', visivel: false }, // 500 Quadrilhões
    { id: 'patrocinio_marca', icone: '🌎', nome: 'Patrocínio Master', desc: 'Duplica TODAS as estruturas (SPS x2). Orçamento milionário entra no canal para bancar os eventos mais insanos.', custo: 50e18, comprado: false, tipo: 'global', visivel: false }, // 50 Quintilhões
    { id: 'estudio_proprio', icone: '🌎', nome: 'Estúdio Próprio Isolado', desc: 'Duplica TODAS as estruturas (SPS x2). Acústica perfeita, cenário impecável, hype incontrolável.', custo: 5e21, comprado: false, tipo: 'global', visivel: false }, // 5 Sextilhões
    { id: 'transmissao_neural', icone: '🌎', nome: 'Transmissão Neural Borboleta', desc: 'Duplica TODAS as estruturas (SPS x2). Você transmite a live diretamente para a mente da sua comunidade.', custo: 500e21, comprado: false, tipo: 'global', visivel: false }, // 500 Sextilhões
